...
//         // Extraer "Bienvenido"
//         String parte1 = saludo.substring(0, 9);
        
//         // Extraer "Java"
//         String parte2 = saludo.substring(13);

//         System.out.println(parte1); // Imprime: Bienvenido
//         System.out.println(parte2); // Imprime: Java
//     }
// }

// String nuevaCadena = original.substring(inicio);        // desde 'inicio' hasta el final
// String nuevaCadena = original.substring(inicio, fin);   // desde 'inicio' hasta 'fin - 1'



// startsWit //

// boolean resultado = cadena.startsWith("prefijo");
// boolean resultado = cadena.startsWith("prefijo", desdeIndice);
